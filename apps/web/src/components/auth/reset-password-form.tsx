      ...
      <Card className="overflow-hidden border-0 bg-transparent shadow-none">
        <CardContent className="p-5 sm:p-7">
          <div className="space-y-5 text-center">
            ...
            <div>
              <h2 className="font-display text-lg font-semibold text-[#171B26] dark:text-white">
                Password updated
              </h2>

              <p className="font-body mt-2 text-sm leading-6 text-[#5B5C63] dark:text-slate-400">
                {successMessage}
              </p>
            </div>

            <div className="flex items-center justify-center gap-2 text-xs text-[#8B8C93] dark:text-slate-500">
              <Loader2
                aria-hidden="true"
            ...
            <Link
              href="/login"
              className="inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#171B26] px-4 text-sm font-medium text-[#F3EFE6] transition hover:bg-[#252A37] dark:bg-white dark:text-[#171B26] dark:hover:bg-slate-200"
            >
              Continue to sign in
            </Link>
          </div>
        ...
        >
          <div className="space-y-2">
            <Label
              ...
              className="text-sm font-medium text-[#292C35] dark:text-slate-200"
            >
              New password
            </Label>
          ...
          {requestError ? (
            <div
              role="alert"
              className="flex items-start gap-3 rounded-xl border border-red-500/15 bg-red-500/[0.06] px-3.5 py-3 text-xs text-red-700 dark:border-red-500/25 dark:bg-red-500/10 dark:text-red-300"
            >
              <AlertCircle
                aria-hidden="true"
          ...
          <Button
            ...
            className="group h-12 w-full rounded-xl bg-[#171B26] text-sm font-semibold text-[#F3EFE6] shadow-lg shadow-[#171B26]/15 transition hover:bg-[#252A37] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white dark:text-[#171B26] dark:hover:bg-slate-200"
          >
            {isSubmitting ? (
              <>
                <Loader2
          ...
          <Link
            href="/login"
            className="flex items-center justify-center gap-2 text-xs font-medium text-[#8A6D2A] transition hover:text-[#6F551F] hover:underline dark:text-[#D9A441] dark:hover:text-[#e8bb63]"
          >
            <ArrowLeft
              aria-hidden="true"
    ...
    <Card className="overflow-hidden border-0 bg-transparent shadow-none">
      <CardContent className="p-5 sm:p-7">
        <div className="space-y-5 text-center">
          ...
          <Link
            href="/forgot-password"
            className="inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#171B26] px-4 text-sm font-semibold text-[#F3EFE6] transition hover:bg-[#252A37] dark:bg-white dark:text-[#171B26] dark:hover:bg-slate-200"
          >
          ...
          <Link
            href="/login"
            className="inline-flex items-center justify-center gap-2 text-xs font-medium text-[#8A6D2A] hover:underline dark:text-[#D9A441]"
          >
            <ArrowLeft
              aria-hidden="true"
              className="h-3.5 w-3.5"
