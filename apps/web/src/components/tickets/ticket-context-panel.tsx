...
import { TicketEmailPanel } from "@/components/tickets/ticket-email-panel";
...
export function TicketContextPanel({ ticket }: { ticket: TicketDetail }) {
  ...
  return (
    <div className="flex w-80 shrink-0 flex-col gap-4 overflow-y-auto border-l border-border p-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={ticket.teamId ?? NO_TEAM}
              onValueChange={(v) =>
                updateTicket.mutate({ id: ticket.id, teamId: v === NO_TEAM ? null : v } as never, { onError })
              }
            >
              <SelectTrigger>
                <SelectValue />
          ...
          <div className="space-y-1.5">
            ...
            <TicketTagsEditor ticketId={ticket.id} tags={ticket.tags} />
          </div>
        </CardContent>
      </Card>
      ...
      <TicketEmailPanel ticket={ticket} />
